...
let missing = fs.readFileSync('e:/HR.sys/missing_code.js', 'utf8');
...
fs.writeFileSync('e:/HR.sys/missing_code_fixed.js', missing);
console.log('Fixed missing code written');
